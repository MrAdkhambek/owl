...
namespace sql {
    ...
    struct bind_traits {
        static_assert(sizeof(T) == 0,
                      "sql: no bind_traits for this type (builtins: arithmetic, bool, string, string_view, const char*, blob, optional<T>, nullptr)");
    };
    ...
    struct bind_traits<T> {
        ...
        [[nodiscard]] static bind_value make(const T v) {
            return bind_value{static_cast<std::int64_t>(v)};
        }
    };
    ...
    struct bind_traits<T> {
        [[nodiscard]] static bind_value make(const T v) {
            return bind_value{static_cast<double>(v)};
        }
    };

    template <>
    struct bind_traits<bool> {
        [[nodiscard]] static bind_value make(const bool v) {
            return bind_value{static_cast<std::int64_t>(v)};
        }
    };
    ...
    struct bind_traits<std::string> {
        [[nodiscard]] static bind_value make(const std::string& v) {
            return bind_value{v};
        }
    };
    ...
    struct bind_traits<std::string_view> {
        [[nodiscard]] static bind_value make(const std::string_view v) {
            return bind_value{std::string{v}};
        }
    };

    template <std::size_t N>
    struct bind_traits<char[N]> {
        [[nodiscard]] static bind_value make(const char (&v)[N]) {
            return bind_value{std::string{v}};
        }
    };
    ...
    struct bind_traits<const char*> {
        [[nodiscard]] static bind_value make(const char* v) {
            return bind_value{std::string{v}};
        }
    };
    ...
    struct bind_traits<std::vector<std::byte>> {
        [[nodiscard]] static bind_value make(const std::vector<std::byte>& v) {
            return bind_value{v};
        }
    };
    ...
    struct bind_traits<std::nullptr_t> {
        [[nodiscard]] static bind_value make(std::nullptr_t) {
            return bind_value{nullptr};
        }
    };
